...
(function ($) {
    $.fn.hoverclock = function (options) {
        ...
        //---------------------------------------------------
        h_hoverClock.append('<div class="hoverclocktext"><a href="#" target="_blank" class="hoverclocklink" style="text-decoration:none">HoverClock</a></div>')
