...
public class ByteRangeViewRender extends AbstractView {
   private static final int DEFAULT_BUFFER_SIZE = 204800; // ..bytes = 200KB.  
     ...
     protected void renderMergedOutputModel(Map<String, Object> objectMap,  
         ...
         String fileName = (String) objectMap.get("name");
         ...
         }else if("download/file".equals(contentType)){
         ...
         response.setHeader("Content-Disposition", disposition + ";filename=" + (fileName!=null?URLEncoder.encode(fileName,"utf-8"):""));  
